...
void CustomCellData::set_flags_name(godot::String name) {
	/*M+M+++M+++M+++M+++M+++M+++M+++M+++M+++M+++M+++M+++M+++M+++M+++M+++M
  Summary: // TODO
  M---M---M---M---M---M---M---M---M---M---M---M---M---M---M---M---M-M*/
	flags_name = name;
...
godot::String CustomCellData::get_flags_name() const {
	/*M+M+++M+++M+++M+++M+++M+++M+++M+++M+++M+++M+++M+++M+++M+++M+++M+++M
  Summary: // TODO
  M---M---M---M---M---M---M---M---M---M---M---M---M---M---M---M---M-M*/
	return flags_name;
...
void CustomCellData::_bind_methods() {
  ...
  M---M---M---M---M---M---M---M---M---M---M---M---M---M---M---M---M-M*/
	...
	godot::ClassDB::bind_method(godot::D_METHOD("set_flags_name"), &CustomCellData::set_flags_name);
	godot::ClassDB::bind_method(godot::D_METHOD("get_flags_name"), &CustomCellData::get_flags_name);
	...
	ADD_PROPERTY(godot::PropertyInfo(godot::Variant::STRING, "flags_name"), "set_flags_name", "get_flags_name");
